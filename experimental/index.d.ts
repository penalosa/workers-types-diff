...
declare function atob(arg1: string): string;
...
declare function clearTimeout(arg0: number | null): void;
...
declare function clearInterval(arg0: number | null): void;
/* [MDN Reference](https://developer.mozilla.org/docs/Web/API/queueMicrotask) */
declare function queueMicrotask(arg1: Function): void;
...
declare function reportError(arg1: any): void;
...
interface DurableObjectStorage {
  ...
  getBookmarkForTime(arg0: number | Date): Promise<string>;
  onNextSessionRestoreBookmark(arg0: string): Promise<string>;
}
...
declare abstract class JsRpcProperty {
  then(arg1: Function, arg2?: Function): any;
  catch(arg1: Function): any;
  finally(arg1: Function): any;
}
...
declare class URLSearchParams {
   ...
   */
  delete(arg1: string, arg2?: string): void;
  /**
...
interface SqlStorage {
  exec(arg1: string, ...arg2: any[]): SqlStorageCursor;
  prepare(arg1: string): SqlStorageStatement;
  ingest(arg1: string): SqlStorageIngestResult;
